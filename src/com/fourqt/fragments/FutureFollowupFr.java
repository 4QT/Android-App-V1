...
public class FutureFollowupFr extends Fragment {
	...
	public static FutureFollowupFr newInstance(Context context,
			ViewPager pager, TabPageIndicator pageIndicatory) {
		FutureFollowupFr fragment = new FutureFollowupFr();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		{
			if(list.getStatus().equalsIgnoreCase("Future"))
