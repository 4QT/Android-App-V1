...
public class NewFollowupFr extends Fragment {
	...
	public static NewFollowupFr newInstance(Context context, ViewPager pager,
			TabPageIndicator pageIndicatory) {
		NewFollowupFr fragment = new NewFollowupFr();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		{
			if(list.getStatus().equalsIgnoreCase("New"))
