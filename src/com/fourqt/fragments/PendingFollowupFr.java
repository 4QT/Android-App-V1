...
import com.fourqt.fragments.TransferredFollowupFr.TodayFollowUpAdapter;
import com.fourqt.model.GetAllLeadListResult;
import com.fourqt.util.CommonContexts;
import com.fourqt.view.R;
import com.viewpagerindicator.TabPageIndicator;

public class PendingFollowupFr extends Fragment {
	...
	public static PendingFollowupFr newInstance(Context context,
			ViewPager pager, TabPageIndicator pageIndicatory) {
		PendingFollowupFr fragment = new PendingFollowupFr();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		{
			if(list.getStatus().equalsIgnoreCase("Pending"))
