...
public class TextViewEx extends TextView {
	...
	/*
	 * @Override public void setPadding(int left, int top, int right, int
	 * bottom) { super.setPadding(left + 10, top, right + 10, bottom); }
	 */
	...
	public void setPadding(int left, int top, int right, int bottom) {
		...
		if (width >= 400 && width <= 540) {
			super.setPadding((int) ((left + (metrics.density * 10))), top,
					(int) (right + (metrics.density * 10)),
					(int) (bottom + (metrics.heightPixels * 0.18)));

		}
		if (width >= 541 && width <= 600) {
			super.setPadding((int) ((left + (metrics.density * 10))), top,
					(int) (right + (metrics.density * 10)),
					(int) (bottom + (metrics.heightPixels * 0.14)));

		}
		if (width <= 800 && height == 1216) {
			super.setPadding((int) ((left + (metrics.density * 10))), top,
					(int) (right + (metrics.density * 10)),
					(int) (bottom + (metrics.heightPixels * 0.04)));

		}
		if (width >= 600 && width <= 800 && height == 1205) {
			super.setPadding((int) ((left + (metrics.density * 10))), top,
					(int) (right + (metrics.density * 10)),
					(int) (bottom + (metrics.heightPixels * 0.16)));

		}
		if (width >= 801 && width <= 1080) {
			super.setPadding((int) ((left + (metrics.density * 10))), top,
					(int) (right + (metrics.density * 10)),
					(int) (bottom + (metrics.heightPixels * 0.16)));
		...
		/*
		 * super.setPadding((int) ((left + (metrics.density * 10))), top, (int)
		 * (right + (metrics.density * 10)), (int) (bottom +
		 * (metrics.heightPixels * 0.02)));
		 */
	}
